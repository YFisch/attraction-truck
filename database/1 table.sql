...
create table dbo.AttractionTruck(
	...
	PricePerDay decimal(7,2) not null constraint ck_AttractionTruck_PricePerDay_must_be_between_50_and_10000 check(PricePerDay between 50 and 10000),
	IsDamaged bit,
	DamageDesc varchar(200) not null default '',
	DamagePrice decimal(8,2) constraint ck_AttractionTruck_DamagePrice_must_be_between_1_and_100000 check(DamagePrice between 1 and 100000),
